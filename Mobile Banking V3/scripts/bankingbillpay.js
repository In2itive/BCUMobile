    ...
    app.bankingBillPayService = {
        ...
        submitBillPayconfirm: function() {
            ...
            submitData = {
                ...
                "Month" :	app.bankingBillPayService.viewModel.billpayInfo.data()[0].startdate.getMonth(),
        ...
        postedString: function (beforeShowEvt) {
            ...
            //alert("confirm");
            tmp_str = "BillPay $" + app.bankingBillPayService.viewModel.billpayInfo.data()[0].amount + " from your<br /><b>" + app.bankingBillPayService.viewModel.billpayInfo.data()[0].fromacct + "</b><br />account to your<br /><b>" + app.bankingBillPayService.viewModel.billpayInfo.data()[0].toacct + "</b><br />account ";
            
        	if (app.bankingBillPayService.viewModel.billpayInfo.data()[0].schedule === 0) {
        		tmp_str = tmp_str + "on " + app.bankingBillPayService.viewModel.billpayInfo.data()[0].startdate;
                tmp_str = tmp_str + "<br />Your <b>" + app.bankingBillPayService.viewModel.billpayInfo.data()[0].fromacct + "</b> available balance is now " + app.bankingBillPayService.viewModel.billpayInfo.data()[0].frombalance + ".";
                tmp_str = tmp_str + "<br />Your <b>" + app.bankingBillPayService.viewModel.billpayInfo.data()[0].toacct + "</b> available balance is now " + app.bankingBillPayService.viewModel.billpayInfo.data()[0].tobalance + ".";                
        	}
        	else {
                tmp_str = tmp_str + " and is scheduled<br />";
        		if (app.bankingBillPayService.viewModel.billpayInfo.data()[0].schedule === 1) { //"Weekly":
